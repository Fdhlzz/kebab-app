      ...
      body: ListView(
        children: [
          ...
          SizedBox(
            ...
            child: AspectRatio(
              aspectRatio: 1.3,
              child: Image.network(product.image), // Using Backend Image
            ),
          ),
            ...
            child: Column(
              children: [
                ...
                TopRoundedContainer(
                  ...
                  child: Column(
                    children: [
                      // Space placeholder where ColorDots used to be
        ...
        Align(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: const Color(
                0xFFFFE6E6,
              ), // Assume isFavourite is true for UI demo
              borderRadius: const BorderRadius.only(
