...
class _MainNavScreenState extends State<MainNavScreen> {
  ...
  BottomNavigationBarItem _buildNavItem(String icon, String label) {
    return BottomNavigationBarItem(icon: SvgPicture.string(icon), label: label);
  }
